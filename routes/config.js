    ...
    try{
        ...
        connPool.addConnection({
            ...
            if(err){
                ...
                // set the new config
                nconf.set('connections:' + req.body[0], {
                    'connection_string': req.body[1],
    ...
    try{
        ...
        connPool.addConnection({
            ...
            if(err){
                ...
                // set the new
                nconf.set('connections:' + req.body.conn_name, {
                    'connection_string': req.body.conn_string,
                    'connection_options': current_options
                });
                ...
                nconf.save(function (err){
                    if(err){
                        ...
                        res.status(200).json({
                            'msg': req.i18n.__('Config successfully updated'),
                            'name': req.body.conn_name,
                            'string': req.body.conn_string
                        });
                    }
                });
            }
